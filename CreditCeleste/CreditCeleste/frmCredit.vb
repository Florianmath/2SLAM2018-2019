...
Public Class frmCredit
    Private Sub frmCredit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'Pour passer le nom du vendeur
        lblVendeur.Text = unVendeur.getEnregistreTousVendeur()
    ...
    Private Sub lblVendeur_Click(sender As Object, e As EventArgs) Handles lblVendeur.Click
