Public Class frmIntroduction
    ...
    Private Sub cmdEnr_Click(sender As Object, e As EventArgs) Handles cmdEnr.Click
        ...
        'unVendeur.setEnregistreVendeur("", "")
        'unVendeur.setEnregistreVendeur(unVendeur.setNomVendeur, unVendeur.getPrenomVendeur)
        unVendeur.setEnregistreTousVendeur(cboVendeur.Text)
